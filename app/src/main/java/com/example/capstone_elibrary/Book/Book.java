package com.example.capstone_elibrary.Book;
...
import com.example.capstone_elibrary.BookTools;
...
public abstract class Book {
    ...
    public static void remove(Context context, File file) {
        try {
            BookTools.deleteDir(getBookDir(context, file));
            String fname = getProperFName(context, file);
    ...
    public boolean remove() {
        BookTools.deleteDir(getThisBookDir());
