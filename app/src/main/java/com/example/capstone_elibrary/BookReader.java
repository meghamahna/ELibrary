...
public class BookReader extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (filename!=null) {
            ...
            if (getSharedPreferences(MainActivity.prefname, Context.MODE_PRIVATE).edit().putBoolean(READEREXITEDNORMALLY, false).commit()) {
    ...
    public void onBackPressed() {
        ...
        main.setAction(MainActivity.ACTION_SHOW_LAST_STATUS);
        startActivity(main);
    }
    ...
    private static class LoaderTask extends AsyncTask<Void,Integer,Book> {
        ...
        private final WeakReference<BookReader> ractref;

        LoaderTask(BookReader ract, File file) {
            this.file = file;
...
//        findViewById(R.id.fullscreen_no_button).setVisibility(View.GONE);
    ...
    protected void onPause() {
        ...
        if (exception==null) {
            ...
            getSharedPreferences(MainActivity.prefname, Context.MODE_PRIVATE).edit().putBoolean(READEREXITEDNORMALLY, true).apply();
        }
        super.onPause();
    }
...
//    }
    ...
    private void setNoAwake() {
        try {
            Window w = BookReader.this.getWindow();
...
//            }
            ...
            BookReader.this.getWindow().setBackgroundDrawable(null);
            webView.setBackgroundColor(color);
            BookReader.this.getWindow().setBackgroundDrawable(new ColorDrawable(color));
